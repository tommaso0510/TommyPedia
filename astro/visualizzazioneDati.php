...
#menu{background-color:darkblue;border-radius:6px;
text-align:center}
...
<?php
    ...
    $database = "tommypedia";
     echo "<br>";
                ...
                print "<img src='gif/$argomento.gif' id='sfondo' >";
    ...
    $sql2 = "SELECT descrizione FROM contenuti WHERE titolo= '$argomento'";
        if($sql2 === FALSE)  
            die(mysqli_error());
...
background-color:rgba(0, 0, 139, 0.58);
                ...
                <?php
                    echo "<div class='box'><font color='white'>$argomento : " . $row2['descrizione']."<br></font></div>";
    ...
    <ul id="playlist">
        <?php
       echo" <li class='current-song'><a href='../audio/$argomento.mp3'></a></li>";
       ?>
    </ul>
