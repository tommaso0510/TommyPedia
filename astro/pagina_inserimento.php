    ...
    mysqli_select_db($conn,$database) or die ('impossibile connettersi al server ' .mysqli_error());
               ...
               echo "Hai scelto $scelta!!!";
                 ...
                 $conn= mysqli_connect("localhost","root" ,"",$database) or die ('impossibile connettersi al server ' .mysqli_error($conn));
                  ...
                  $sql2 = "SELECT titolo FROM contenuti where id_argomentoAstro = '$scelta'" ;
                  if($sql2 === FALSE)  
                  die(mysqli_error());
                  ...
                  $result2 = mysqli_query($conn,$sql2) or die( mysqli_error($conn));
                    ...
                    { 
                  echo "<table width='5%' border='1'  bgcolor='#0089ff'>";
                    ...
                    echo "<form class= 'koi'action='visualizzazioneDati.php' method='POST'>";
                        echo "<input placeholder='Argomento' style='background-color: darkblue; width: 20%;'  type='text' name='argomento'/>";
                       echo" <input type='submit' class='button button1' value='Scopri' name='Entra a Hogwars'>";
                    echo "</form>";
                ?>
         ...
         <span STYLE="background:darkblue;">  
            ...
            Vuoi aggiornare l'enciclopedia?</span></font>
				   <tr>    <td><div id="div2"><input name="Titolo" placeholder="Titolo" style="background-color: darkblue; width: 10%;" type="text" /></div></td>
				   </tr>
                  
				  <tr>   
                      <td><div id="div2"><textarea name="Argomento" placeholder="Argomento" style="background-color: darkblue;" rows="10" cols="70"  ></textarea></div></td>
				  </tr>
    ...
    mysqli_select_db($conn,$database) or die ('impossibile connettersi al server ' .mysqli_error());
                ...
                $titolo=$_POST['Titolo'];
                   ...
                   $scelta= $_SESSION['scelta'];
                    ...
                    $query_insert="INSERT INTO contenuti(titolo,descrizione, id_argomentoAstro) VALUES ('$titolo', '$argomento','$scelta')";
                    ...
                    echo "<font color='#ffffff'><p><span STYLE='background:darkblue;'> L'aggiornamento e' avvenuto con successo! <br>Torna indietro per scegliere l'argomento.</p></font>";
                ...
                echo "<form action='eloginAstro.php'>";
